...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.controlLayout.setWidget(0, QFormLayout.LabelRole, self.tabletLbl)
        ...
        self.controlLayout.setWidget(1, QFormLayout.LabelRole, self.toolLbl)
...
"        }"))
        ...
        self.controlLayout.setWidget(1, QFormLayout.FieldRole, self.toolScroll)
        ...
        self.controlLayout.setWidget(2, QFormLayout.LabelRole, self.configLbl)
...
"        }"))
        ...
        self.controlLayout.setLayout(0, QFormLayout.FieldRole, self.horizontalLayout)
...
"        }"))
        ...
        self.controlLayout.setLayout(2, QFormLayout.FieldRole, self.horizontalLayout_2)
